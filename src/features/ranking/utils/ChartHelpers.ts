...
export const getResponsiveOptions = (): Partial<ChartOptions<"line">> => {
  return {
    responsive: true,
...
export const getMobileOptions = (): Partial<ChartOptions<"line">> => {
  return {
...
export const getDesktopOptions = (): Partial<ChartOptions<"line">> => {
  return {
    ...getResponsiveOptions(),
    plugins: {
      legend: {
...
export const getOptimalChartOptions = (width?: number): Partial<ChartOptions<"line">> => {
