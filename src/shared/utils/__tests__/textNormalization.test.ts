...
describe("textNormalization", () => {
  ...
  describe("Real character search scenarios", () => {
    it("should find characters with various search patterns", () => {
      ...
      expect(
        multiFieldJapaneseMatch([testCharacters[0].name, testCharacters[0].nameEn], "きき"),
      ).toBe(true);
      expect(
        multiFieldJapaneseMatch([testCharacters[1].name, testCharacters[1].nameEn], "はろー"),
      ).toBe(true);

      // Test English search
      expect(
        multiFieldJapaneseMatch([testCharacters[0].name, testCharacters[0].nameEn], "little"),
      ).toBe(true);
      expect(
